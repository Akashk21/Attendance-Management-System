    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Attendance Portal</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li class="active"><a href="#">Home</a></li>
            <li><a href="https://pes.edu/">About</a></li>
            <li><a href="https://pes.edu/contact/">Contact</a></li>
    ...
    <table class="table table-bordered table-striped">
     ...
     <!-- FOOTER -->
      <footer style="background:; height:120%;">
        ...
        <p>&copy;       2022 PES UNIVERSITY, Inc. &middot;  developed by  <a href="https://github.com/Akashk21/SE_Project">Abhishek, Akash, Aniket </a></p>
      </footer>
